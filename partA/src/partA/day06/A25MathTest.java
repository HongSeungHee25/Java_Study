...
public class A25MathTest {
	...
	public static void main(String[] args) {
		...
		//int dmin = Math.min(56.78, 111.44); //강제 캐스팅
		...
		System.out.println("Math.round(3.141519*1000.0)/1000.0 = "+Math.round(3.141519*1000.0)/1000.0);
		System.out.println("Math.round(3.141219*1000.0)/1000.0 = "+Math.round(3.141219*1000.0)/1000.0);
		double num = 3.141519;
		double roundeNum = Math.round(num * 1000.0)/1000.0;
		System.out.println(roundeNum);
		
		//1231, 1236 를 십의 자리까지 반올림은 / 하고 * => 복습으로 해오세요.
