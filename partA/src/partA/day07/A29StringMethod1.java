...
public class A29StringMethod1 {
	...
	public static void main(String[] args) {
		...
		//인자는 int 1개 , 리턴 타입은 char 타입이다.
		int i = 0;	//문자열의 첫번째 문자 위치는 0으로 시작을 합니다. 위치는 index 라고 합니다.
		System.out.println("name.charAt(0) = "+name.charAt(i));	//i = 0 , 리턴 'm'
		i++; 
		System.out.println("name.charAt(0) = "+name.charAt(i));	//i = 1 , 리턴 'o'
		i++; 
		System.out.println("name.charAt(0) = "+name.charAt(i));	//i = 2 , 리턴 'm'
		i++;
		System.out.println("name.charAt(0) = "+name.charAt(i));	//i = 3 , 리턴 'o'
