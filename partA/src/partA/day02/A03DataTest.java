...
public class A03DataTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("3. 논리형식 boolean은 참 또는 거짓을 표현합니다.");
		...
		weight = weight - 1.3;
		System.out.println("운동 후 감량된 몸무게 : "+weight);
		weight -= 1.3; 		//weight = weight - 1.3 수식을 줄여서 쓰는 형식
		System.out.printf("운동 후 감량된 몸무게 : %.2f\n",weight);
		...
		System.out.println((age >= 20)?"성인 입니다.":"청소년 입니다.");//검사하고 싶은 수식? 참일때 : 거짓일때 
		age = 17;
		System.out.println("나이 age를 17세로 변경해서 다시 실행하면?");
		System.out.println((age >= 20)?"성인 입니다.":"청소년 입니다.");//검사하고 싶은 수식? 참일때 : 거짓일때 
		...
		//아래과 같은 경우는 = 기준 오른쪽과 왼쪽 타입이 일치하지 않으므로 오류
		//age = age >= 20;
		
		double myWeight = weight + 3.5;
		System.out.printf("새로운 나의 몸무게 : %.2f\n",myWeight);
