...
public class A06DoubleFloatTest {
	...
	public static void main(String[] args) {
		...
		double dnum2 = 1.1234567890123456789f; //4바이트 실수를 8바이트 변수로 자동 캐스팅
		...
		System.out.println("(예시) 0.1 + 1.6 = "+(0.1 + 1.6)); //연상의 최우선순위는 () 입니다.
		...
		long data4 = 2147483648L; //long 8바이트로 표현해야하는 큰값은 리터럴에 L(소문자도 가능) 추가 필수
