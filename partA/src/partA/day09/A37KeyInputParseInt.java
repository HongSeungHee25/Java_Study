...
public class A37KeyInputParseInt {
	...
	public static void main(String[] args) {
		...
		System.out.println("정수 입력 후 문자열 입력~~");
		//키보드 입력한 문자가 저장되는 메모리 영역에는
		//예시 : 22엔터
		System.out.print("나이 입력하세요. >>> ");
		age = Integer.parseInt(sc.nextLine());	//parse""는 스트링을 정수,실수 등등으로 바꿔준다는 뜻
		...
		//		잎으로 배울 여러가지 데이터 교환에서도 문자열이 기본입니다.
	}
	//★★★★★★중요 꼭 이해하기★★★★★★
	//Boolean,Character,Integer,Long,Double,.... 원시 타입에 대한 처리 기능을 갖는 Wrapper 클래스
	//String 에서 int,double,long,....원시타입으로 변환 : Wrapper 클래스.parseXXXX("문자열");
