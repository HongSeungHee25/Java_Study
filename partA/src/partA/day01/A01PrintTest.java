package partA.day01;
//패키지 이름은 com.naver.api 와 같은 도메인주소 형식입니다.
/*
 * 복습 : 1. 출력문 2. 사용자 정의한 메소드 aboutClass
...
public class A01PrintTest {	//개발자가 만든 클래스
	...
	public static void main(String[] args) {	//실행을 위해 필요한 메소드, main은 메소드 이름 : 실행프로그램의 메소드
		...
		aboutSystem();
		System.out.println();
		System.out.println("===메소드를 만들면 코드 재사용이 됩니다.===");
		aboutClass();
		aboutSystem();
	}
		public static void aboutClass() { //aboutClass 이라는 이름의 메소드 정의 : 개발자가 정한 이름
			...
			System.out.println("- 메소드의 이름은 소문자로 시작하고 소괄호 ()가 따라온다.(Rule)");
	}
		public static void aboutSystem() {
			...
			System.out.println("- ptintln 은 out이 갖고 있는 메소드(기능)이다.");
			System.out.println("- System 은 out 을, out은 println을 구성요소로 포함하고 있다.");
			System.out.println("- 명령으로 작성할 때 .(dot)기호로 포함관계를 표시한다.");
		}
}
/*
 * 이클립스 단축키 : 저장 > Ctrl + s, 실행 > Ctrl + F11, 한줄 복사 : Ctrl + Alt + 위/아래 방향키 한줄
 * 삭제 > Ctrl + d, 자동 완성 > Ctrl + 스페이스바, 라인 이동 : Alt + 위/아래 방향키
 * 오류 수정 가이드 > Ctrl + 1
 */