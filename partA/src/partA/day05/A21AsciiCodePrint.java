...
//				break;
//			}
			if(code == 0)break;   //2)while 종료 조건
			
			//32~126이 아닐 때는 다시 입력받기. //1)번이 있고 0값이 아래 continue 조건에 해당하면 2)번 필요없음.
		...
		//break,continue 는 for 문에서도 쓰입니다.
		//문제 : 두번째 while 문이 몇번 실행됬는지 구해봅시다.
		sc.close();
	}
