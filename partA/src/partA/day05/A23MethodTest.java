...
public class A23MethodTest {
	...
	public static void main(String[] args) {
		...
		//result = methodAA(); //오류 : main에서는 static만 사용 가능
	}
	...
	private static int methodA() {	//리턴형식 : int. void이면 리턴 없음.
		//return "1234"; //오류
		//return 12.345; //오류
		return 1234;	//정상 : 리턴형식 int와 일치하는 값을 return
	}
	//2. static (정적인) : 간단히 설명하자면, main은 꼭 static 입니다. static은 static만 사용할 수 있다.
	//static이 없으면 인스턴스 메소드라고 합니다.
	public int methodAA() {
		return 1234;
	}
	//3. 인자가 있는 형식 예시 : 인자를 정수값을 1개 받아서 출력하기. 리턴은 없음.
	public static void methodB(int number) {//int number가 메소드가 처리할 데이터(재료)를 저장합니다. 
