...
//자바 클래스 String 클래스의 생성자 테스트. String 클래스 생성자의 오버로딩 예시.
public class B08StringConstuctor {
	
	public static void main(String[] args) {
		
		String str1 = new String(); //매개변수 없는 기본 생성자로 객체 생성
		System.out.println("str1 = "+str1+",길이 = "+str1.length()); 	//str1은 ""(주의 : null 아님)
		
		String str2 = new String("hello hi!"); //매개변수 문자열 1개받는 객체 생성
