...
//ArratList<E> : <E> 에서 E는 Element 약자, <> 제너릭 타입 기호. 리스트에서 다룰 데이터의 클래스 타입을 지정.
...
//새로운 자료구조 ArratList 연습합니다. 배열과 동작방식이 유사한 List 자료구조 중 하나입니다.
...
//		System.out.println(list.get(7));	//오류 : 인덱스 범위 out of bounds(범위를 넘어갔음)
		...
		boolean reault = list.remove(Integer.valueOf(11));
		System.out.println("=====================================");
		System.out.println(">>>list.remove(Integer.valueOf(11)) 실행 후<<<"); 
		System.out.println("remove result = "+reault);
		System.out.println(list+", 리스트의 크기 = "+list.size()); 
		System.out.println("=====================================");
		reault = list.remove(Integer.valueOf(77));
		...
		System.out.println("2) 찾는 데이터가 어디에 있느냐? - index");
