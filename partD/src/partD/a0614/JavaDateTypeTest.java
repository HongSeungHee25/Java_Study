...
public class JavaDateTypeTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("---현재 시간을 ms 로 구하는 방식은 모든 프로그래밍언어에서 사용합니다.");
		
		System.out.println("\n2. 약 53년을 직접 ms 로 계산해보기");
		long oneday = 24*60*60*1000;		//24시간에 대한 ms 값
		long oneyear = 365*oneday;			//365일에 대한 ms 값
		...
		//java.sql.Date 는 기본생성자 동작 없습니다. long 타입 인자가 필요합니다.
		System.out.println("java.sql.Date 클래스 : "+new java.sql.Date(now));
