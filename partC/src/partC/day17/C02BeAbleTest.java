...
//		Runnable run2 = new AI(); 		//오류 : AI는 Runnable의 구현클래스가 아님.
		...
		for (Thinkable t : thinks) {
			...
			if(t instanceof Human) System.out.println("나 휴먼 계산 중입니다.....");
			else if(t instanceof AI) System.out.println("나 AI 계산 중입니다.....");
			else {System.out.println("알 수 없는 객체입니다."); break; }
